  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        <button type="button" onClick={() => document.getElementById("secao-atrasados")?.scrollIntoView({ behavior: "smooth", block: "start" })} className="text-left rounded-xl ring-1 ring-red-400/70 shadow-[0_10px_25px_-8px_rgba(239,68,68,0.55)] hover:ring-red-500/80 hover:shadow-[0_16px_32px_-10px_rgba(239,68,68,0.7)] transition-all cursor-pointer"><StatCard title="Atrasados" value={overdue.length} icon={AlertTriangle} gradient="from-red-500 to-red-600" /></button>
        <button type="button" onClick={() => document.getElementById("secao-proximos")?.scrollIntoView({ behavior: "smooth", block: "start" })} className="text-left rounded-xl ring-1 ring-orange-400/70 shadow-[0_10px_25px_-8px_rgba(249,115,22,0.55)] hover:ring-orange-500/80 hover:shadow-[0_16px_32px_-10px_rgba(249,115,22,0.7)] transition-all cursor-pointer"><StatCard title="Vence amanhã" value={tomorrow.length} icon={Clock} gradient="from-orange-400 to-orange-600" pulse={tomorrow.length > 0} /></button>
        <button type="button" onClick={() => document.getElementById("secao-proximos")?.scrollIntoView({ behavior: "smooth", block: "start" })} className="text-left rounded-xl ring-1 ring-yellow-400/70 shadow-[0_10px_25px_-8px_rgba(234,179,8,0.55)] hover:ring-yellow-500/80 hover:shadow-[0_16px_32px_-10px_rgba(234,179,8,0.7)] transition-all cursor-pointer"><StatCard title="Próximos 3 dias" value={next3.length} icon={TrendingUp} gradient="from-yellow-400 to-amber-500" /></button>
        <Link to="/concluidas" className="block cursor-pointer rounded-xl ring-1 ring-emerald-400/70 shadow-[0_10px_25px_-8px_rgba(16,185,129,0.55)] hover:ring-emerald-500/80 hover:shadow-[0_16px_32px_-10px_rgba(16,185,129,0.7)] transition-all"><StatCard title="Pagos" value={paidCount} icon={CheckCircle2} gradient="from-emerald-400 to-emerald-600" /></Link>
        <Link to="/concluidas" className="block cursor-pointer rounded-xl ring-1 ring-sky-400/70 shadow-[0_10px_25px_-8px_rgba(56,189,248,0.55)] hover:ring-sky-500/80 hover:shadow-[0_16px_32px_-10px_rgba(56,189,248,0.7)] transition-all"><StatCard title="Finalizados" value={finalizados.length} icon={Trophy} gradient="from-sky-400 to-blue-600" /></Link>
      </div>
