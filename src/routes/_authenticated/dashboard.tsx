  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        <button type="button" onClick={() => document.getElementById("secao-atrasados")?.scrollIntoView({ behavior: "smooth", block: "start" })} className="text-left rounded-xl ring-1 ring-red-200/60 shadow-[0_8px_20px_-12px_rgba(239,68,68,0.25)] hover:ring-red-300/60 hover:shadow-[0_12px_26px_-14px_rgba(239,68,68,0.4)] transition-all cursor-pointer"><StatCard title="Atrasados" value={overdue.length} icon={AlertTriangle} gradient="from-red-300 to-red-400" /></button>
        <button type="button" onClick={() => document.getElementById("secao-proximos")?.scrollIntoView({ behavior: "smooth", block: "start" })} className="text-left rounded-xl ring-1 ring-orange-200/60 shadow-[0_8px_20px_-12px_rgba(249,115,22,0.25)] hover:ring-orange-300/60 hover:shadow-[0_12px_26px_-14px_rgba(249,115,22,0.4)] transition-all cursor-pointer"><StatCard title="Vence amanhã" value={tomorrow.length} icon={Clock} gradient="from-orange-200 to-orange-400" pulse={tomorrow.length > 0} /></button>
        <button type="button" onClick={() => document.getElementById("secao-proximos")?.scrollIntoView({ behavior: "smooth", block: "start" })} className="text-left rounded-xl ring-1 ring-yellow-200/60 shadow-[0_8px_20px_-12px_rgba(234,179,8,0.25)] hover:ring-yellow-300/60 hover:shadow-[0_12px_26px_-14px_rgba(234,179,8,0.4)] transition-all cursor-pointer"><StatCard title="Próximos 3 dias" value={next3.length} icon={TrendingUp} gradient="from-yellow-200 to-amber-300" /></button>
        <Link to="/concluidas" className="block cursor-pointer rounded-xl ring-1 ring-emerald-200/60 shadow-[0_8px_20px_-12px_rgba(16,185,129,0.25)] hover:ring-emerald-300/60 hover:shadow-[0_12px_26px_-14px_rgba(16,185,129,0.4)] transition-all"><StatCard title="Pagos" value={paidCount} icon={CheckCircle2} gradient="from-emerald-200 to-emerald-400" /></Link>
        <Link to="/concluidas" className="block cursor-pointer rounded-xl ring-1 ring-sky-200/60 shadow-[0_8px_20px_-12px_rgba(56,189,248,0.25)] hover:ring-sky-300/60 hover:shadow-[0_12px_26px_-14px_rgba(56,189,248,0.4)] transition-all"><StatCard title="Finalizados" value={finalizados.length} icon={Trophy} gradient="from-sky-200 to-blue-400" /></Link>
      </div>
