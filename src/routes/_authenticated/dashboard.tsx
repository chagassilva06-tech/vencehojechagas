  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        <button type="button" onClick={() => document.getElementById("secao-atrasados")?.scrollIntoView({ behavior: "smooth", block: "start" })} className="text-left rounded-xl ring-2 ring-red-300/50 shadow-[0_12px_28px_-10px_rgba(239,68,68,0.4)] hover:ring-red-300/70 hover:shadow-[0_18px_36px_-12px_rgba(239,68,68,0.55)] transition-all cursor-pointer"><StatCard title="Atrasados" value={overdue.length} icon={AlertTriangle} gradient="from-red-400 to-red-600" /></button>
        <button type="button" onClick={() => document.getElementById("secao-proximos")?.scrollIntoView({ behavior: "smooth", block: "start" })} className="text-left rounded-xl ring-2 ring-orange-300/50 shadow-[0_12px_28px_-10px_rgba(249,115,22,0.4)] hover:ring-orange-300/70 hover:shadow-[0_18px_36px_-12px_rgba(249,115,22,0.55)] transition-all cursor-pointer"><StatCard title="Vence amanhã" value={tomorrow.length} icon={Clock} gradient="from-orange-300 to-orange-500" pulse={tomorrow.length > 0} /></button>
        <button type="button" onClick={() => document.getElementById("secao-proximos")?.scrollIntoView({ behavior: "smooth", block: "start" })} className="text-left rounded-xl ring-2 ring-yellow-300/50 shadow-[0_12px_28px_-10px_rgba(234,179,8,0.4)] hover:ring-yellow-300/70 hover:shadow-[0_18px_36px_-12px_rgba(234,179,8,0.55)] transition-all cursor-pointer"><StatCard title="Próximos 3 dias" value={next3.length} icon={TrendingUp} gradient="from-yellow-300 to-amber-400" /></button>
        <Link to="/concluidas" className="block cursor-pointer rounded-xl ring-2 ring-emerald-300/50 shadow-[0_12px_28px_-10px_rgba(16,185,129,0.4)] hover:ring-emerald-300/70 hover:shadow-[0_18px_36px_-12px_rgba(16,185,129,0.55)] transition-all"><StatCard title="Pagos" value={paidCount} icon={CheckCircle2} gradient="from-emerald-300 to-emerald-500" /></Link>
        <Link to="/concluidas" className="block cursor-pointer rounded-xl ring-2 ring-sky-300/50 shadow-[0_12px_28px_-10px_rgba(56,189,248,0.4)] hover:ring-sky-300/70 hover:shadow-[0_18px_36px_-12px_rgba(56,189,248,0.55)] transition-all"><StatCard title="Finalizados" value={finalizados.length} icon={Trophy} gradient="from-sky-300 to-blue-500" /></Link>
      </div>
