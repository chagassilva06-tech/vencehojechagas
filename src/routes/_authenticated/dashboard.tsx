  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        <button type="button" onClick={() => document.getElementById("secao-atrasados")?.scrollIntoView({ behavior: "smooth", block: "start" })} className="text-left rounded-xl ring-4 ring-red-400/70 shadow-[0_20px_45px_-8px_rgba(239,68,68,0.75)] hover:ring-red-300 hover:shadow-[0_30px_60px_-10px_rgba(239,68,68,0.9)] transition-all cursor-pointer"><StatCard title="Atrasados" value={overdue.length} icon={AlertTriangle} gradient="from-red-500 to-red-700" /></button>
        <button type="button" onClick={() => document.getElementById("secao-proximos")?.scrollIntoView({ behavior: "smooth", block: "start" })} className="text-left rounded-xl ring-4 ring-orange-400/70 shadow-[0_20px_45px_-8px_rgba(249,115,22,0.75)] hover:ring-orange-300 hover:shadow-[0_30px_60px_-10px_rgba(249,115,22,0.9)] transition-all cursor-pointer"><StatCard title="Vence amanhã" value={tomorrow.length} icon={Clock} gradient="from-orange-400 to-orange-600" pulse={tomorrow.length > 0} /></button>
        <button type="button" onClick={() => document.getElementById("secao-proximos")?.scrollIntoView({ behavior: "smooth", block: "start" })} className="text-left rounded-xl ring-4 ring-yellow-400/70 shadow-[0_20px_45px_-8px_rgba(234,179,8,0.75)] hover:ring-yellow-300 hover:shadow-[0_30px_60px_-10px_rgba(234,179,8,0.9)] transition-all cursor-pointer"><StatCard title="Próximos 3 dias" value={next3.length} icon={TrendingUp} gradient="from-yellow-400 to-amber-500" /></button>
