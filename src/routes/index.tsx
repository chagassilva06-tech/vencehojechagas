...
function Landing() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-[#EAF3FC] via-[#D2E6FA] to-[#B7D5F3] flex items-center justify-center p-4 md:p-10">
      ...
      {/* Card */}
      <div className="relative w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 rounded-2xl overflow-hidden bg-white ring-1 ring-black/5 shadow-[0_20px_50px_-24px_rgba(21,101,216,0.35),0_10px_24px_-16px_rgba(0,0,0,0.15)]">
        {/* Left: form */}
          ...
          <div className="relative w-full max-w-sm rounded-2xl bg-gradient-to-br from-[#F5FAFF] to-[#E3EFFC] ring-1 ring-black/5 shadow-[0_15px_40px_-20px_rgba(21,101,216,0.35)] p-4">
            ...
            <ul className="space-y-1.5">
              {[
                ...
                <li key={r.label} className="flex items-center justify-between rounded-lg bg-white px-2.5 py-1.5 ring-1 ring-black/5">
